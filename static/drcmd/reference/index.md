...
- [`SL.hal9001()`](https://keithbarnatchez.github.io/drcmd/reference/SL.hal9001.md)
...
- [`plot(`*`<drcmd>`*`)`](https://keithbarnatchez.github.io/drcmd/reference/plot.drcmd.md)
  : Plot results from drcmd object
- [`print(`*`<drcmd>`*`)`](https://keithbarnatchez.github.io/drcmd/reference/print.drcmd.md)
  : Print drcmd object
- [`summary(`*`<drcmd>`*`)`](https://keithbarnatchez.github.io/drcmd/reference/summary.drcmd.md)
  : Summarize results from drcmd
- [`predict(`*`<SL.hal9001>`*`)`](https://keithbarnatchez.github.io/drcmd/reference/predict.SL.hal9001.md)
